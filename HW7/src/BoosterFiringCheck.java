...
public class BoosterFiringCheck extends Atomic {/////0 output is int 1 output is rocket
    ...
    public String deltaConfluent(ArrayList b, int index, double e) {
        if (internalStates.size() < 1) {
            ...
            if (rocket.getThermalStabilityFactor() >= (50+(random.nextInt(25))-(random.nextInt(25)))) {//pass (0, rocket)(rocket.getThermalStabilityFactor() > (75+(random.nextInt(25))-(random.nextInt(25))))
                outputs.set(0, 0);
